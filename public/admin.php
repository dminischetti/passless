        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <?php if (empty($securityEvents)): ?>
                    <tr><td colspan="3">No security events logged.</td></tr>
                <?php else: ?>
                    <?php foreach ($securityEvents as $event): ?>
                        ...
                        <tr>
                            ...
                            <td><pre class="mini-json"><?= htmlspecialchars(json_encode($context, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?></pre></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
                </tbody>
